...
$table->setText(0, 0, '<font color="#ffffff"><b>Generador de codigo de barra</b></font>');
...
$table->setText(3, 0, 'Tamaño');
$table->setText(3, 1, display_thickness($thickness));
$table->setText(4, 0, 'Resolucion');
$table->setText(4, 1, display_res($res));
$table->setText(5, 0, 'Rotacion');
$table->setText(5, 1, display_rotation($rotation));
$table->setText(6, 0, 'Letras');
$table->setText(6, 1, display_font($font_family, $font_size));
$table->setText(7, 0, 'Codigo Barras');
$table->setText(7, 1, display_text($text2display));
$table->addCellAttribute(8, 0, 'align', 'center');
$table->addCellAttribute(8, 0, 'colspan', '2');
$table->setText(8, 0, '<input type="submit" value="GENERAR CODIGO" />');
